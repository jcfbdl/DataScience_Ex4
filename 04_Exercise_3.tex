...
As presented in Figure \ref{SP500_returns_criterion} when using $W=\Sigma^{-1}$ the fourth moment condition is somewhat completely ignored due to the size of the fourth moment's variance (Therefore the weight of the fourth moment condition being insignificant compared to that of the second moment).
